                ...
                <div class="col-lg-6">
                    <div class="about_info pl-70">
                        <div class="section_title mb-55">
                            <h3>We are Hus <br><?php $i=0; { foreach ($display as $data) { $i++;?>
                                <span><?php echo $data->head;?></span></h3>
                            <div class="devider">
                                <span></span>
                                <span></span>
                            </div>
                        ...
                        <div class="info_inner">
                            ...
                            <ul>
                                <li><?php echo $data->firstpoint;?></li>
                                <li><?php echo $data->secondpoint;?></li>
                                <li><?php echo $data->thirdpoint;?></li>
                                <li><?php echo $data->fourthpoint;?></li>
                            </ul><?php } } ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_feature text-center">
                        ...
                        </div><?php $i=0; { foreach ($new as $data) { $i++;?>
                ...
                <div class="col-lg-8">
                    <div class="certificate_listing d-flex justify-content-between align-items-center">
                        <div class="single_list">
                            <div class="thumb">
                                <img src="<?php echo base_url();?>assets/img/certificates/1.png" alt="">
                            </div>
                        </div>
                        <div class="single_list">
                            <div class="thumb">
                                <img src="<?php echo base_url();?>assets/img/certificates/2.png" alt="">
                            </div>
                        </div>
                        <div class="single_list">
                            <div class="thumb">
                                <img src="<?php echo base_url();?>assets/img/certificates/3.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="appertment_area">
        <div class="appertment_active owl-carousel">
            <div class="single_appertment">
                <div class="thumb">
                    <img src="<?php echo base_url();?>assets/img/appertment/1.png" alt="">
                </div>
            ...
            <div class="single_appertment">
                <div class="thumb">
                    <img src="<?php echo base_url();?>assets/img/appertment/2.png" alt="">
                </div>
                <div class="appertment_info">
                    <span>$35.000</span>
                    <a href="#">
            ...
            <div class="single_appertment">
                <div class="thumb">
                    <img src="<?php echo base_url();?>assets/img/appertment/3.png" alt="">
                </div>
                <div class="appertment_info">
                    <span>$35.000</span>
                    <a href="#">
                                ...
                                <div class="col-lg-9">
                                    <div class="single_testmonial text-center">
                                        <div class="author_thumb">
                                            <img src="<?php echo base_url();?>assets/img/testmonial/author.png" alt="">
                                        </div>
                        ...
                        <div class="single_carousel">
                            <div class="row justify-content-center">
                                <div class="col-lg-9">
                                    <div class="single_testmonial text-center">
                                        <div class="author_thumb">
                                            <img src="<?php echo base_url();?>assets/img/testmonial/author2.png" alt="">
                                        </div>
                                        <div class="testmonial_author">
                                            <h3>Margaret Lawson</h3>
                                            <span>Creative Director</span>
