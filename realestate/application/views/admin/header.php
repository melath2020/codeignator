      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">HOME</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="addhead" target="_blank" rel="noopener"><i class="icon fa fa-circle-o"></i>Add Head and Subhead</a></li>
            <li><a class="treeview-item" href="viewaddhead"><i class="icon fa fa-circle-o"></i>View add Head </a></li>
            <li><a class="treeview-item" href="ourfacilities" target="_blank" rel="noopener"><i class="icon fa fa-circle-o"></i>Add Our Facilities</a></li>
             <li><a class="treeview-item" href="<?php echo base_url();?>viewourfacilities" target="_blank" rel="noopener"><i class="icon fa fa-circle-o"></i>View Our Facilities</a></li>
            
          </ul>
        </li>
        <li><a class="app-menu__item" href="charts.html"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">ABOUT US</span></a></li>
        ...
        <li class="treeview"><a class="app-menu__item" href="chat" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">CHAT BOX</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
