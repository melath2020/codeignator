      ...
      <div class="app-title">
        ...
        <div class="col-md-6">
          <div class="tile">
            ...
            <div class="tile-body">
               <form class="form-horizontal" method="post" enctype="multipart" action="<?php echo base_url();?>updatefacilities/<?php echo $data->id;?>">
                <div class="form-group row">
                  <label class="control-label col-md-3">HEAD</label>
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="head" value="<?php echo $data->head;?>" >
                  </div>
                </div>
