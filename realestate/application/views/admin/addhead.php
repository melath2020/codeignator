            ...
            <div class="tile-body">
               <form class="form-horizontal" method="post" enctype="multipart" action="<?php echo base_url();?>insert">
                ...
                <label class="control-label col-md-3">Main 4 points</label>
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="firstpoint" placeholder="Enter First point">
                      <input class="form-control" type="text" name="secondpoint" placeholder="Enter Second point">
                        <input class="form-control" type="text" name="thirdpoint" placeholder="Enter Third point">
                          <input class="form-control" type="text" name="fourthpoint" placeholder="Enter Fourth point">
