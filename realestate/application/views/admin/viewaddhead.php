                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>  
                    ...
                    <tr>
                      ...
                      <td><?php echo $data->firstpoint;?></td>
                      <td><?php echo $data->secondpoint;?></td>
                      <td><?php echo $data->thirdpoint;?></td>
                      <td><?php echo $data->fourthpoint;?></td>
                      <td><a href="<?php echo base_url();?>edit/<?php echo $data->id;?>"><button>edit</button></a></td>
                      <td><button><a href="<?php echo base_url();?>delete/<?php echo $data->id;?>">delete</a></button></td>
                    </tr>
                     <?php } } ?>
